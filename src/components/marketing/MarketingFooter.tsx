...
const FOOTER_SECTIONS: FooterSection[] = [
  {
    ...
    links: [
      ...
      { label: "Pipeline & Going Cold", href: "/features/pipeline-kanban" },
      { label: "Automations", href: "/features/automations" },
      { label: "AI Assistant", href: "/features/ai" },
      { label: "Meetings & Booking", href: "/features/meetings" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Education & Coaching", href: "/usecases/education" },
      { label: "Clinics & Healthcare", href: "/usecases/clinics" },

...
export function FeatureShowcase() {
  ...
  const extraFeatures = [
    ...
    },
    {
      ...
      description: "Meta & Google Lead Ads, Google Calendar, Meta Conversions API, a REST API and signed webhooks.",
    },
    {
      icon: FileText,
      href: "/features/team-and-security",
      title: "Team, Roles & Security",
      description: "Invite your team, control what each person can do with custom roles, and see who changed what.",
    },
  ];
